...
## 🏆 Bảng Kết Quả Benchmark (Leaderboard)

> Kết quả được tổng hợp trực tiếp từ kết quả huấn luyện và đánh giá trên pipeline đồng nhất (`seed=42`, mã băm tập dữ liệu `c32f956aee64...`).
